...
import com.itheima.security.distributed.domain.returnDto.LoginInfo;
import com.itheima.security.distributed.domain.returnDto.LoginParam;
import com.itheima.security.distributed.domain.returnDto.OrderStatus;
import com.itheima.security.distributed.domain.returnDto.ResponseResult;
import com.itheima.security.distributed.domain.returnDto.UserDTO;
import com.itheima.security.distributed.exceptionHander.OrderException;
import com.itheima.security.distributed.feign.ProfileFeign;
import com.itheima.security.distributed.service.SpringDataUserDetailsService;
import com.itheima.security.distributed.utils.MapperUtils;
import com.itheima.security.distributed.utils.OkHttpClientUtil;
...
//            sendAdminLoginLog(userDetails.getUsername(), request);
    ...
    public ResponseResult<LoginInfo> info() throws Exception {
        ...
        if (user!=null){
            ...
            System.out.println("order-loginInfo="+loginInfo.toString());
...
//            return  MapperUtils.json2pojo(MapperUtils.obj2json(loginInfo),ResponseResult.class);
    ...
    public ResponseResult<Void> logout(HttpServletRequest request) {
        ...
        System.out.println("order-logout-token="+token);//打印测试
        // 删除 token 以注销
