package com.itheima.security.distributed.feign;

import com.itheima.security.distributed.config.FeignRequestConfiguration;
...
import com.itheima.security.distributed.feign.fallback.MyFallBack;
...
@FeignClient(value = "user-service", path = "my/user",configuration = FeignRequestConfiguration.class,fallbackFactory = MyFallBack.class/*,fallback = ProfileFeignFallback.class*/)
public interface ProfileFeign {
    ...
    ResponseResult<User> update(@RequestBody ProfileParam profileParam);
    /**
     * 修改密码
    ...
    ResponseResult<User> modifyIcon(@RequestBody IconParam iconParam);
}
